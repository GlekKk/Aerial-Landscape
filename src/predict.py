...
# MODEL_PATH = os.path.join(CURRENT_DIR, '..', 'simplecnn_model.pth') - for SimpleCNN
MODEL_PATH = os.path.join(CURRENT_DIR, '..', 'resnet_model.pth')

IMAGE_PATH = os.path.join(CURRENT_DIR, '..', 'write_your_image_name.jpg') 
