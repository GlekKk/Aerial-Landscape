...
HISTORY_PATH = os.path.join(CURRENT_DIR, '..', 'simplecnn_history.json')
# HISTORY_PATH = os.path.join(CURRENT_DIR, '..', 'resnet_history.json') - for ResNet18
...
def plot_metrics():
    ...
    plt.title('Loss SimpleCNN', fontsize=14)
    ...
    plt.title('Accuracy SimpleCNN', fontsize=14)
    plt.xlabel('Epochs', fontsize=12)
    ...
    plt.tight_layout()
    save_path = os.path.join(CURRENT_DIR, '..', 'simplecnn_history_plot.png')
